...
public class UserCartListAdapter extends ArrayAdapter<StoreItem> {
    ...
    public UserCartListAdapter(Context context, int resource, ArrayList<StoreItem> items,
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if(convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.cart_items_list_view,parent,false);
